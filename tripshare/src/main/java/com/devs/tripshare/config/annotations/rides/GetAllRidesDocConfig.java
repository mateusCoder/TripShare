...
@Operation(summary = "List all rides paginated", description = "This method returns a pagination of all registered rides.", tags = {"Ride"})
...
public @interface GetAllRidesDocConfig {
