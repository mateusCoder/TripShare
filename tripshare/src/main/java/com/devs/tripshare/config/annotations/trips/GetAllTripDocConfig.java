...
@Operation(summary = "List all trips paginated", description = "This method returns a pagination of all registered trips.", tags = {"Trip"})
...
public @interface GetAllTripDocConfig {
